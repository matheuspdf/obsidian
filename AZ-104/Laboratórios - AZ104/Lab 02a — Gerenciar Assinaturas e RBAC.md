...
_Diagrama das tarefas do lab._
...
5. Pesquise e selecione **Grupos de gerenciamento**.
...
4. Em **Permissões de linha de base**, selecione **Clonar uma função**. No menu suspenso **Função a clonar**, selecione **Colaborador de Solicitação de Suporte**.
...
2. Revise as atividades para atribuições de função. O log de atividades pode ser filtrado para operações específicas.
