...
![Diagram of the tasks.](https://raw.githubusercontent.com/MicrosoftLearning/AZ-104-MicrosoftAzureAdministrator/master/Instructions/media/az104-lab03-architecture.png)
...
9. From the **Template** section, click **Download** and save the template to the local drive. Then switch to the **Parameters** section and do the same.
    
10. Use File Explorer to open the **Downloads** folder on your computer. Notice there are two JSON files (template and parameters).
...
1. Select the **Cloud Shell** icon in the top right of the Azure Portal. Alternately, you can navigate directly to `https://shell.azure.com`.
    ...
    ![Screenshot of cloud shell icon.](https://raw.githubusercontent.com/MicrosoftLearning/AZ-104-MicrosoftAzureAdministrator/master/Instructions/media/az104-lab03-cloudshell-icon.png)
...
4. Select **I want to create a storage account** and then **Next**. Complete the **Create storage account** information.
    ...
    |---|---|
    |Resource Group|**az104-rg3**|
    |Region|_select your region_|
    |Storage account (Create new)|_must be globally unique, between 3 and 24 characters in length and use numbers and lower case letters only_|
...
10. Make a change. For example, change the disk name to **az104-disk3**. Use **Ctrl+S** to save your changes, then **Ctrl+Q** to close the editor.
...
4. Make a change. For example, change the disk name to **az104-disk4**. Use **Ctrl+S** to save your changes, then **Ctrl+Q** to close the editor.
...
1. Locate the **F:\Allfiles\Labs\03\azuredeploydisk.bicep** file.
...
8. Use **Ctrl+S** to save your changes, then **Ctrl+Q** to close the editor.
