...
### 5.1.4 Questões de ética corporativas

Muitos profissionais de TI, como a [Information Systems Security Association](https://www.issa.org/code-of-ethics/) (ISSA) publicaram códigos de ética para ajudar a orientar as ações e os comportamentos dos funcionários.

A Cisco também tem uma [equipe](https://www.cisco.com/c/m/en_us/about/csr/esg-hub.html) dedicada exclusivamente à conduta ética dos negócios e um [Código de Conduta Empresarial](http://investor.cisco.com/investor-relations/governance/code-of-conduct/default.aspx) para ajudar os funcionários a tomar decisões comerciais e resolver quaisquer problemas que possam surgir.

## 5.2 Educação e carreiras
### 5.2.1 Torne-se um guru da segurança digital
Você se destacou em sua função como analista de segurança de nível básico na @Apollo , mas há muitas tarefas de cibersegurança a serem consideradas.

Mesmo que você esteja apenas começando sua carreira de segurança cibernética, é uma boa ideia começar a analisar mecanismos de busca de emprego, como [Indeed](https://www.indeed.com/), [LinkedIn](https://www.linkedin.com/), [Monster](http://jobs.monster.com/search/?q=cybersecurity) e [CareerBuilder](http://www.careerbuilder.com/jobs/keyword/cyber-security) para ter uma noção do tipo de emprego disponível em todo o mundo!
...
### 5.2.3 Percursos de carreira em segurança **cibernética**
A CyberSeek é uma ferramenta que fornece dados detalhados sobre oferta e demanda no mercado de trabalho de segurança digital para ajudar a preencher a lacuna de habilidades em Cibersegurança. [Clique aqui](http://www.cyberseek.org/pathway.html) para ver o plano de carreira interativo que mostra a gama de empregos em segurança cibernética, bem como informações detalhadas sobre os salários, credenciais e conjuntos de habilidades associadas a cada trabalho.
![[Pasted image 20260329080142.png]]

## 5.3. Questionário

**Pergunta 1**

Qual é a diferença entre um hacker e um profissional de cibersegurança?

- ( ) Os hackers operam apenas dentro dos limites legais
- ( ) Profissionais de cibersegurança não devem ter as mesmas habilidades dos hackers.
- ( ) Os hackers têm habilidades especiais que os profissionais de cibersegurança não têm
- **(x) Os profissionais de cibersegurança devem trabalhar dentro dos limites legais** ✅

---

> **Explicação:** A principal diferença não está nas habilidades técnicas — profissionais de cibersegurança podem (e devem) conhecer as mesmas técnicas dos hackers. O que os distingue é o **contexto legal e ético**: profissionais de cibersegurança sempre operam dentro dos limites legais e com autorização, enquanto hackers maliciosos não.
...
- **(x) Os profissionais de cibersegurança desenvolvem muitas habilidades que podem ser usadas para o bem ou para o mal** ✅
- ( ) Os profissionais de cibersegurança desenvolvem muitas habilidades que podem ser usadas para o bem
- ( ) Os profissionais de cibersegurança desenvolvem muitas habilidades que não podem ser usadas para o mal
- ( ) Os profissionais de cibersegurança desenvolvem muitas habilidades que podem ser usadas para o mal

---

> **Explicação:** As habilidades técnicas em cibersegurança são de **duplo uso** — as mesmas competências usadas para defender sistemas podem ser usadas para atacá-los. Por isso, a **ética e a legalidade** são fundamentais na atuação do profissional de cibersegurança.